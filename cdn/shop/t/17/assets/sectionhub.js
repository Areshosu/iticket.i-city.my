...
Line 15:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 2286:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 2287:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 2288:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 2293:18 Transforming const to the configured target environment ("es5") is not supported yet
Line 2293:24 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 2307:20 Transforming const to the configured target environment ("es5") is not supported yet
